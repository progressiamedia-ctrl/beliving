    ...
    <html lang="es" className="h-full bg-white">
      <head>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `document.documentElement.style.backgroundColor = '#ffffff'; document.documentElement.classList.remove('dark'); localStorage.removeItem('theme');`
        }} />
      </head>
      <body className={`${montserrat.className} min-h-full bg-white text-gray-900`}>
